...
class AdminTaiKhoan
{
    ...
    public function updateTaiKhoan($id, $ho_ten, $email, $so_dien_thoai, $ngay_sinh, $dia_chi, $trang_thai)
    {
        try {
            // var_dump($id);die;
    ...
    public function updateTaiKhoanWithAvatar($id, $ho_ten, $email, $so_dien_thoai, $ngay_sinh, $dia_chi, $anh_dai_dien, $trang_thai)
    {
        try {
            $sql = 'UPDATE tai_khoans
                SET
