      ...
      (function(w, d) {
        ! function(bH, bI, bJ, bK) {
          if (bH.zaraz) console.error("zaraz is loaded twice");
            ...
            bH.zaraz._v = "5876";
            bH.zaraz._n = "a7afd72b-d856-4912-87bc-53aecc3af007";
            bH.zaraz.q = [];
...
<body class="hold-transition login-page">
  <div class="login-box">
    <!-- /.login-logo -->
    <div class="card card-outline card-primary" style="    border-top: 3px solid #921817;">
      <div class="card-header text-center">
        <a href="../../index2.html" class="h1"><b>WATCH HUB</a>
      </div>
      <div class="card-body">
        ...
        <form action="<?= BASE_URL_ADMIN . '?act=check-login-admin' ?>" method="post">
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block" style="background-color: #921817; border: none;">Đăng nhập</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
        <p class="mb-1 mt-2">
          <a href="" style="font-weight: 500;">Quên mật khẩu</a>
        </p>
      </div>
      <!-- /.card-body -->
    </div>
